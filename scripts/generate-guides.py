...
<main id="main-content" class="guides-page guides-index">
  ...
  <section class="guide-index-note glass">
    ...
    <p>
      InfoparkDaily publishes community job digests and career guidance for Kerala’s tech audience. We source public
      openings and Recruit submissions, but we are <strong>not the employer</strong>. Use
      <a href="/jobs/">Jobs</a> to browse listings,
      <a href="/news/">News</a> for campus updates, and
      <a href="/media/">About Us</a> to learn who we are.
    </p>
  </section>
</main>
"""
