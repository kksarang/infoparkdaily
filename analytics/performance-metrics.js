/**
 * InfoparkDaily Analytics — Performance metrics (Phase 12)
 * =========================================================
 * Core Web Vitals + resource / error signals for GA4 & Looker.
 * Thresholds follow Google CWV guidance (approx. field targets).
 */
(function (global) {
  "use strict";
  ...
  function shortUrl(url) {
    try {
      var u = new URL(url, (global.location && global.location.href) || undefined);
  ...
  function analyzeResources(entries, opts) {
    opts = opts || {};
  ...
  function readNavTiming() {
    try {
      var list = global.performance && global.performance.getEntriesByType
  ...
  global.IPD_ANALYTICS_PERFORMANCE = {
    METRICS: METRICS,
