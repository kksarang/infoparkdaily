...
export const EVENTS = {
  ...
  RESUME_EXPORT_START: "resume_export_start",
  RESUME_EXPORT_SUCCESS: "resume_export_success",
  RESUME_EXPORT_ERROR: "resume_export_error",
  PORTFOLIO_GALLERY_VIEW: "portfolio_gallery_view",
  PORTFOLIO_TEMPLATE_PREVIEW: "portfolio_template_preview",
  PORTFOLIO_TEMPLATE_SELECT: "portfolio_template_select",
  PORTFOLIO_TRY_CLICK: "portfolio_try_click",
  PORTFOLIO_START: "portfolio_start",
  PORTFOLIO_SAVE_SUCCESS: "portfolio_save_success",
  PORTFOLIO_PUBLISH_SUCCESS: "portfolio_publish_success",
...
export const CATALOG = [
  ...
  { name: "login_start", object: "login", action: "start", desc: "User initiates sign-in", params: ["method", "feature", "placement"] },
  { name: "login", object: "login", action: "success", desc: "Confirmed successful sign-in", params: ["method", "feature"] },
  { name: "sign_up", object: "sign", action: "up", desc: "Confirmed new account creation", params: ["method", "feature"] },
  ...
  { name: "resume_step_complete", object: "resume", action: "step_complete", desc: "Editor section completed", params: ["step_name", "template_id"] },
  { name: "resume_save_success", object: "resume", action: "save_success", desc: "Cloud/local persistence succeeded", params: ["template_id"] },
  { name: "resume_export_start", object: "resume", action: "export_start", desc: "Export/print initiated", params: ["template_id"] },
  { name: "resume_export_success", object: "resume", action: "export_success", desc: "File generation / print dialog opened", params: ["template_id"] },
  { name: "resume_export_error", object: "resume", action: "export_error", desc: "Export failed (sanitized)", params: ["error_category"] },
  { name: "portfolio_gallery_view", object: "portfolio", action: "gallery_view", desc: "Portfolio gallery opened", params: ["page_type"] },
  { name: "portfolio_template_preview", object: "portfolio", action: "template_preview", desc: "Portfolio preview opened", params: ["template_id", "template_category"] },
  { name: "portfolio_template_select", object: "portfolio", action: "template_select", desc: "Template detail / choose", params: ["template_id"] },
  { name: "portfolio_try_click", object: "portfolio", action: "try_click", desc: "Try / preview CTA click", params: ["template_id", "placement"] },
  { name: "portfolio_start", object: "portfolio", action: "start", desc: "Order dialog opened / personalisation started", params: ["template_id", "package_id"] },
  { name: "portfolio_save_success", object: "portfolio", action: "save_success", desc: "Portfolio save confirmed (if implemented)", params: ["template_id"] },
  { name: "portfolio_publish_success", object: "portfolio", action: "publish_success", desc: "Publication confirmed (if implemented)", params: ["template_id"] },
  { name: "pricing_view", object: "pricing", action: "view", desc: "Pricing section viewed", params: ["feature", "page_type"] },
  { name: "package_select", object: "package", action: "select", desc: "Package chosen in UI", params: ["package_id", "domain_option", "feature"] },
  { name: "whatsapp_click", object: "whatsapp", action: "click", desc: "Outbound WhatsApp click (not message sent)", params: ["feature", "package_id", "placement", "template_id"] },
  { name: "generate_lead", object: "generate", action: "lead", desc: "Lead successfully recorded", params: ["feature", "package_id"] },
  { name: "navigation_click", object: "navigation", action: "click", desc: "Primary product nav click", params: ["button_id", "placement", "route_name"] },
  { name: "form_submit_success", object: "form", action: "submit_success", desc: "Form submit succeeded", params: ["feature", "form_id"] },
  { name: "form_submit_error", object: "form", action: "submit_error", desc: "Form submit failed (sanitized)", params: ["feature", "error_category"] }
];
