/**
 * InfoparkDaily Analytics — Business metrics (Phase 16 ESM)
...
export const METRICS = [
  ...
  },
  {
    ...
    events: [EVENTS.SPONSOR_VIEW, EVENTS.SPONSOR_CLICK],
...
export function isEmployerLead(reason, extra) {
  extra = extra || {};
...
export function leadType(reason, extra) {
...
export function calcContactCvr(submits, starts) {
...
export function calcSponsorCtr(clicks, views) {
 ...
 */
export function attributionKeys(params) {
  params = params || {};
  return {
    date: params.date || "",
