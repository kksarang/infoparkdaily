...
var JOBS = [
  {
    ...
    skills: ["Python", "SQL", "Data visualization", "Statistics", "Data modeling", "Training / mentoring"],
    responsibilities: [
    ...
    benefits: ["Calicut-based trainer role", "Immediate joiner preference", "Teaching + analytics career path"],
  ...
  },
  {
    ...
    skills: ["HTML/CSS/JS", "SQL", "REST APIs", "Postman", "Debugging", "Documentation"],
    responsibilities: [
    ...
    benefits: ["Infopark Kochi campus role", "Immediate joiner preference"],
  ...
  },
  {
    ...
    skills: ["MS Office", "Communication", "Documentation", "Scheduling", "Coordination"],
    responsibilities: [
    ...
    benefits: ["Fresher-friendly admin role", "Angamaly location", "Immediate joiner preference"],
  ...
  },
  {
    ...
    source: "WhatsApp",
    verified: true,
    tags: ["Sales", "Marketing", "Internship", "Business"],
    isWalkIn: false,
    walkInDate: "",
    ...
    skills: ["Business development", "Marketing", "MS Office", "Communication", "Market research"],
    responsibilities: [
    ...
    benefits: ["Infopark Thrissur campus", "Multiple role tracks including internships", "Immediate joiner preference"],
  ...
  },
  {
    ...
    roles: ["Software Tester (QA Engineer)"],
    experience: "fresher",
    ...
    skills: ["Manual Testing", "SDLC/STLC", "Jira", "Postman", "SQL", "Functional testing"],
    responsibilities: [
    ...
    benefits: ["Technopark on-site role", "Immediate joiner preference"],
  ...
  },
  {
    ...
    roles: ["Senior QA Testing Engineer"],
    ...
    skills: ["Manual Testing", "LLM testing", "Test agents", "Persona-based validation", "AI application QA"],
    responsibilities: [
    ...
    benefits: ["Hybrid Bangalore schedule", "Budget 1–1.3 LPM (poster)", "2–3 openings"],
  ...
  },
  {
    ...
    source: "WhatsApp",
    verified: true,
    tags: ["Sales", "Marketing", "Business", "IT"],
    isWalkIn: false,
    walkInDate: "",
    email: "",
    phone: "",
    ...
    skills: ["Operations", "SEO", "Lead generation", "Social media", "Inbound sales"],
    responsibilities: [
    ...
    benefits: ["Cyberpark Calicut campus", "Cybersecurity domain exposure"],
  ...
  {
    id: "sutherland-kochi-walkin-cs",
    company: "Sutherland",
    logo: "assets/logos/sutherland.svg",
    companyBlurb: "Kochi Walk-in Drive · Customer Support · 23 July 2026 · Technopolis C-Sez Kakkanad.",
    location: "Infopark / Kakkanad, Kochi",
    roles: ["Customer Support Roles"],
    experience: "fresher",
    experienceRange: "10+2 pass · Good English",
    employmentType: "Full-time",
    applyLink: "",
    applyDeadline: "2026-07-23",
    postedDate: "2026-07-21",
    source: "WhatsApp",
    verified: true,
    tags: ["Support", "Business"],
    isWalkIn: true,
    walkInDate: "23 July 2026 · 11:30 AM – 4:00 PM · Sutherland, 5th Floor, Technopolis, C-Sez, Kakkanad",
    email: "",
    phone: "",
    website: "",
    address: "Sutherland, 5th Floor, Technopolis, C-Sez, Kakkanad, Kochi",
    industry: "BPO / Customer Support",
    companyDetails: "Sutherland Kochi walk-in drive for Customer Support roles at Technopolis, C-Sez, Kakkanad.",
    workDetails: "Walk-in on 23 July 2026, 11:30 AM – 4:00 PM. Eligibility: 10+2 pass + good spoken/written English.",
    workStatus: "Full-time · Walk-in",
    workMode: "On-site · Kochi",
    experienceYears: "Entry-level / as per drive",
    requirements: [
      "10+2 pass certificate",
      "Good spoken and written English language skills",
      "Attend walk-in with required documents"
    ],
    skills: ["Customer support", "English communication"],
    responsibilities: ["Customer support operations as assigned at Sutherland Kochi"],
    benefits: [
      "Competitive pay",
      "Employee benefits",
      "Travel allowance",
    ...
    howToApply: "Attend the walk-in at Sutherland, 5th Floor, Technopolis, C-Sez, Kakkanad on 23 July 2026 (11:30 AM – 4:00 PM). Carry certificates and ID. Verify details with Sutherland before travelling.",
    hiringNotes: "WALK-IN DATE 23 July 2026 — if you are viewing this after that date, treat as EXPIRED unless Sutherland confirms another drive.",
    description: "Walk-in · Customer Support · 23 Jul 2026 · Technopolis Kakkanad",
  ...
  },
  {
    ...
    skills: ["Customer support", "English communication"],
    responsibilities: ["Customer support as assigned after selection"],
    benefits: [
      "Competitive pay",
      "Employee benefits",
      "Travel allowance",
