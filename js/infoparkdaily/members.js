  ...
  document.querySelector("#verify-form").onsubmit = (e) =>
    run(e, async () => {
      if (!(await C.verifyAgain()))
        throw Error(
          "The email is still unverified. Open the link in your inbox, then try again.",
        );
