...
import { renderResume, esc } from "./render.js?v=20260920tpl";
import { publicTemplates } from "./catalog.js?v=20260920tpl";
...
function pricing() {
  page(
    "Pricing",
    "Resume making and ATS checks are free. Portfolio websites are personalised by our team.",
    `<div class="pricing-grid pricing-grid-career"><section class="card price-card"><div class="eyebrow">Always free</div><h2>Resume &amp; ATS</h2><div class="price">₹0 <small>always</small></div><p>Create a resume and check a file you already have. No charge for templates or PDF export.</p><ul><li>All ${templates.length} resume templates</li><li>Sign in to save drafts in the cloud</li><li>Live A4 preview and text PDF</li><li>On-device ATS checker — nothing uploaded</li></ul><a class="button" href="${base}templates/">Create a resume</a></section><section class="card price-card"><div class="eyebrow">Portfolio</div><h2>Portfolio Website</h2><div class="price">₹999 <small>one-time</small></div><p>One-page portfolio personalised from any listed template.</p><ul><li>Responsive desktop, tablet and mobile</li><li>About, skills, projects and contact</li><li>Resume download and public profile links</li><li>Hosted subdomain or your own domain</li></ul><a class="button" href="/portfolio/">See templates</a></section><section class="card price-card"><div class="eyebrow">Portfolio</div><h2>Portfolio + Domain</h2><div class="price">₹1,999 <small>first year</small></div><p>Portfolio website plus an eligible custom domain for the first year.</p><ul><li>Everything in Portfolio Website</li><li>Eligible standard-price domain, year one</li><li>DNS setup and HTTPS</li><li>A professional link for your resume</li></ul><a class="button" href="/portfolio/">See templates</a></section><section class="card price-card"><div class="eyebrow">Portfolio</div><h2>Shop + Domain</h2><div class="price">₹3,499</div><p>Portfolio with a simple product or catalogue section, plus domain.</p><ul><li>Everything in Portfolio + Domain</li><li>Product or service catalogue</li><li>WhatsApp enquiry links (no payment gateway)</li><li>For makers, bakeries and side hustles</li></ul><a class="button" href="/portfolio/">See templates</a></section><section class="card price-card"><div class="eyebrow">Portfolio</div><h2>Extra pages + Domain</h2><div class="price">₹4,999</div><p>Multi-page site with separate About, Services and Contact pages.</p><ul><li>Everything in Portfolio + Domain</li><li>Dedicated navigation, not one long page</li><li>Room for team bios and service lists</li><li>Best for consultants and studios</li></ul><a class="button" href="/portfolio/">See templates</a></section><section class="card price-card"><div class="eyebrow">Business</div><h2>Business website</h2><div class="price"><small>Custom quote</small></div><p>Full business site with domain, hosting and professional email — via Enitexa.ai.</p><ul><li>Beyond template personalisation</li><li>Business email (hello@yourcompany.com)</li><li>Custom integrations and ongoing support</li><li>Scoped in a written quote before you pay</li></ul><a class="button" href="/software-solutions/#contact">Request a quote</a></section></div><div class="card pricing-note"><h3 style="font-size:18px">What is free vs paid</h3><p style="font-size:14px">Resume builder and the ATS checker stay ₹0. Portfolio amounts are for a site we personalise for you — details on <a href="/portfolio/terms/">portfolio terms</a>. Sign in only to save resume drafts.</p><p class="hint">${useLocalApi() ? "Local preview · accounts stay on this computer." : "Cloud resume saves start after you verify your email."}</p></div>`,
  );
}
