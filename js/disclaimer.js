...
(function () {
  var FULL_DISCLAIMER_HTML = [
    ...
    "    </div>",
    '    <div class="ipd-disclaimer-card">',
    "      <h3>Mobile app · resume help &amp; job requests</h3>",
    "      <p>The InfoparkDaily <strong>mobile app</strong> is the same community platform. <strong>Guest login is required</strong> as an option: as Guest you only see the <strong>job list</strong>. Tapping <strong>Templates</strong> or <strong>Resume builder</strong> sends you to the <strong>login screen</strong>. After login, the app can show job requests (Recruit-style) and resume creating help. It is not Infopark official and not a recruiter. Resume help is free for candidates — we do not send your resume to companies unless you apply yourself. Verify listings in the app the same way as on the website. Full rules: <a href=\"/privacy/#guest-login\">Privacy</a> and <a href=\"/terms/#guest-login\">Terms</a>.</p>",
    "    </div>",
    '    <div class="ipd-disclaimer-card">',
  ...
  var LIMITED_DISCLAIMER_HTML = [
    ...
    "    <strong>Note</strong>",
    "    <span>Community help only — website and mobile app. Data from outside public sources. Not the employer. Strictly verify genuineness yourself. Never pay for a job, interview, or resume “push”. InfoparkDaily is not responsible for outcomes. See Privacy &amp; Terms.</span>",
