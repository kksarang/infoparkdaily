...
(function () {
  var FULL_DISCLAIMER_HTML = [
    ...
    "      <h3>Who we are</h3>",
    "      <p>InfoparkDaily is an independent community platform. We are <strong>not Infopark management</strong>, not Technopark / Cyberpark authority, not company HR, not a recruitment agency, and not a government body. We help job seekers discover openings.</p>",
    "    </div>",
    '    <div class="ipd-disclaimer-card">',
    ...
    "      <p>We are not affiliated with Infopark, Technopark, Cyberpark, or any IT company unless explicitly stated. Company names and logos belong to their owners.</p>",
    "    </div>",
    '    <div class="ipd-disclaimer-card">',
