const CACHE_NAME = "infoparkdaily-v181";
const PRELOAD_ASSETS = [
  ...
  "./data/jobs-data.js?v=20260808b",
  "./data/technopark-jobs-data.js?v=20260807c",
  "./data/infopark-jobs-data.js?v=20260808b",
